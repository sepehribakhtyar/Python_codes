...
model.add(tf.keras.layers.Dense(units=5, activation='relu',kernel_initializer=initializer_1, bias_initializer='ones', kernel_regularizer=regularizers.l1_l2(l1=1e-5, l2=1e-4), bias_regularizer=regularizers.l2(1e-4), activity_regularizer=regularizers.l2(1e-5),kernel_constraint=None, bias_constraint=None))
...
model.fit(x=Xtrain, y=Ytrain, batch_size=1, epochs=1000, validation_split=0.2, shuffle=True)
